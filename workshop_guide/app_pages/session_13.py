...
PROMPT_13_1 = """In PORT_AI_DEMO.PORT_OPS, run these observability queries:
...
PROMPT_13_2 = """In PORT_AI_DEMO.PORT_OPS, analyze our workshop's AI cost footprint:
...
PROMPT_13_3 = """In PORT_AI_DEMO.PORT_OPS, create a final summary of everything we built today:
...
- 1 semantic view (PORT_OPERATIONS_VIEW)
